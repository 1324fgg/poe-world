# Adding New Games to PoE-World: Alien, Assault, Skiing

This document explains **what was added**, **why**, and **how to run** the three new games
(Alien, Assault, Skiing) on top of the original PoE-World baseline.

---

## Background

PoE-World (["Learning Programs as World Models"](https://arxiv.org/abs/...)) originally
supports four Atari games: MontezumaRevenge, Pong, Pitfall, and Breakout.
This extension adds three new games from the OCAtari suite to serve as additional
baselines and evaluation environments for a comparative study.
...
See [the discussion in the companion README](README.md) for a full analysis of how
PoE-World handles stochastic dynamics.
